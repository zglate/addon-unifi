...
The sidebar view also works in the Home Assistant mobile companion app
(validated on iOS; Android uses the same code path), including over Home
Assistant Cloud. In the mobile app UniFi shows a dismissable "the browser you
