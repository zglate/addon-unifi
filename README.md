...
**Use at your own risk.** I am not a professional developer. This fork exists solely because the upstream addon is slow to merge version updates. If you want a battle-tested, community-supported addon, use the [official one](https://github.com/hassio-addons/addon-unifi).
